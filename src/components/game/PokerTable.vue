...
const SEAT_LAYOUTS = {
  6: [
    { style: { bottom: '-10%', left: '50%', transform: 'translate(-50%, 50%)' }, pos: 'bottom' },
    { style: { bottom: '15%', left: '-5%', transform: 'translate(-50%, 50%)' }, pos: 'left' },
    { style: { top: '15%', left: '-5%', transform: 'translate(-50%, -50%)' }, pos: 'left' },
    { style: { top: '-10%', left: '50%', transform: 'translate(-50%, -50%)' }, pos: 'top' },
    { style: { top: '15%', right: '-5%', transform: 'translate(50%, -50%)' }, pos: 'right' },
    { style: { bottom: '15%', right: '-5%', transform: 'translate(50%, 50%)' }, pos: 'right' },
  ],
  7: [
    { style: { bottom: '-10%', left: '50%', transform: 'translate(-50%, 50%)' }, pos: 'bottom' },
    { style: { bottom: '18%', left: '-6%', transform: 'translate(-50%, 50%)' }, pos: 'left' },
    { style: { top: '50%', left: '-9%', transform: 'translate(-50%, -50%)' }, pos: 'left' },
    { style: { top: '18%', left: '-6%', transform: 'translate(-50%, -50%)' }, pos: 'left' },
    { style: { top: '-10%', left: '50%', transform: 'translate(-50%, -50%)' }, pos: 'top' },
    { style: { top: '18%', right: '-6%', transform: 'translate(50%, -50%)' }, pos: 'right' },
    { style: { bottom: '18%', right: '-6%', transform: 'translate(50%, 50%)' }, pos: 'right' },
  ],
  8: [
    { style: { bottom: '-10%', left: '50%', transform: 'translate(-50%, 50%)' }, pos: 'bottom' },
    { style: { bottom: '18%', left: '-6%', transform: 'translate(-50%, 50%)' }, pos: 'left' },
    { style: { top: '55%', left: '-9%', transform: 'translate(-50%, -50%)' }, pos: 'left' },
    { style: { top: '18%', left: '-6%', transform: 'translate(-50%, -50%)' }, pos: 'left' },
    { style: { top: '-10%', left: '50%', transform: 'translate(-50%, -50%)' }, pos: 'top' },
    { style: { top: '18%', right: '-6%', transform: 'translate(50%, -50%)' }, pos: 'right' },
    { style: { top: '55%', right: '-9%', transform: 'translate(50%, -50%)' }, pos: 'right' },
    { style: { bottom: '18%', right: '-6%', transform: 'translate(50%, 50%)' }, pos: 'right' },
  ],
  9: [
    { style: { bottom: '-6%', left: '50%', transform: 'translate(-50%, 50%)' }, pos: 'bottom' },
    { style: { bottom: '18%', left: '-2%', transform: 'translate(-50%, 50%)' }, pos: 'left' },
    { style: { top: '55%', left: '-4%', transform: 'translate(-50%, -50%)' }, pos: 'left' },
    { style: { top: '18%', left: '-2%', transform: 'translate(-50%, -50%)' }, pos: 'left' },
    { style: { top: '-6%', left: '50%', transform: 'translate(-50%, -50%)' }, pos: 'top' },
    { style: { top: '22%', left: '50%', transform: 'translate(-50%, -50%)' }, pos: 'top' },
    { style: { top: '18%', right: '-2%', transform: 'translate(50%, -50%)' }, pos: 'right' },
    { style: { top: '55%', right: '-4%', transform: 'translate(50%, -50%)' }, pos: 'right' },
    { style: { bottom: '18%', right: '-2%', transform: 'translate(50%, 50%)' }, pos: 'right' },
  ],
  10: [
    // Seat 0 (Bottom center)
    { style: { bottom: '-14%', left: '50%', transform: 'translate(-50%, 50%)' }, pos: 'bottom' },

    // Right side (center-anchored)
    { style: { bottom: '18%', right: '2%', transform: 'translate(50%, 50%)' }, pos: 'right' },
    { style: { bottom: '38%', right: '-8%', transform: 'translate(50%, 50%)' }, pos: 'right' },
    { style: { top: '38%', right: '-8%', transform: 'translate(50%, -50%)' }, pos: 'right' },
    { style: { top: '18%', right: '2%', transform: 'translate(50%, -50%)' }, pos: 'right' },

    // Seat 5 (Top center)
    { style: { top: '-14%', left: '50%', transform: 'translate(-50%, -50%)' }, pos: 'top' },

    // Left side (center-anchored)
    { style: { top: '18%', left: '2%', transform: 'translate(-50%, -50%)' }, pos: 'left' },
    { style: { top: '38%', left: '-8%', transform: 'translate(-50%, -50%)' }, pos: 'left' },
    { style: { bottom: '38%', left: '-8%', transform: 'translate(-50%, 50%)' }, pos: 'left' },
    { style: { bottom: '18%', left: '2%', transform: 'translate(-50%, 50%)' }, pos: 'left' },
  ],
};
